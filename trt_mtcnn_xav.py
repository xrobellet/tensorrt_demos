...
def identify (X_img_path, mtcnn, resnet, distance_min=0.3, distance_threshold=0.7, k=3, num=0):
    """
    ...
    dets, landmarks = mtcnn.detect(img, minsize=20)
...
def main():
    ...
    with open('/facenet_pytorch/data/2020_12_17_Tensorsnames_residents.pkl', 'rb') as f:
        nananames = pickle.load(f)

 
    identify ('/facenet_pytorch/data/pictures_blog_update/picture4088.jpg', mtcnn, resnet, distance_min=0.3, distance_threshold=0.6, k=3, num=0)
