...
def identify (X_img_path, mtcnn, resnet, embeddings_db=None, names=None, distance_min=0.3, distance_threshold=0.6, k=3, num=0):
    """
...
def main():
    ...
    identify (full_path, mtcnn, resnet, embeddings_db=embeddings_db, names=names, distance_min=0.3, distance_threshold=0.7, k=3, num=0)
